        ...
        <div class="card-body">
            <form action="{{ route('admin.master.resto.update') }}" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nama_resto" id="nama_resto"
                        class="form-control {{ $errors->has('nama_resto') ? 'is-invalid' : '' }}" placeholder="Nama Resto"
                        value="{{ old('nama_resto', $resto->nama_resto) }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nama_pemilik" id="nama_pemilik"
                        ...
                        placeholder="Nama Pemilik" value="{{ old('nama_pemilik', $resto->nama_pemilik) }}">
                ...
                <div class="form-group">
                    ...
                    <textarea name="alamat" id="alamat" class="form-control {{ $errors->has('alamat') ? 'is-invalid' : '' }}"
                        placeholder="Alamat" cols="30" rows="10">{{ old('alamat', $resto->alamat) }}</textarea>
